        ...
        {doctorsData.slice(0, initialDoctorCount).map((doctor, idx) => (
          <div
            ...
            style={{
              background: "#ffffff",
              borderRadius: "16px",
              boxShadow: hoveredCard === idx ? "0 18px 40px rgba(0, 122, 126, 0.2)" : "0 8px 20px rgba(0, 122, 126, 0.08)",
              overflow: "hidden",
              cursor: "pointer",
          ...
          >
            ...
            <p style={{ fontSize: "16px", color: "#007a7e", fontWeight: "600", margin: "0 0 10px" }}>
              {doctor.specialty}
            </p>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "30px", alignItems: "flex-start" }}>
        <div style={{ flexShrink: 0, textAlign: "center" }}>
          <img
            ...
            onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/180x180/CCCCCC/666666?text=Dr+Img"; }}
          />
          <h3 style={{ fontSize: "28px", fontWeight: "700", color: "#004d4f", marginTop: "20px", marginBottom: "5px" }}>
            {selectedDoctor.name}
          </h3>
          <p style={{ fontSize: "18px", color: "#007a7e", fontWeight: "600", margin: "0" }}>
        ...
        <div style={{ flexGrow: 1, minWidth: "280px" }}>
          <h4 style={{ fontSize: "22px", fontWeight: "700", color: "#004d4f", marginBottom: "10px" }}>
            About Dr. {selectedDoctor.name.split(' ')[1]}
          </h4>
          <p style={{ fontSize: "16px", color: "#5a6778", lineHeight: "1.7", marginBottom: "20px" }}>
            {selectedDoctor.bio}
          </p>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: "0 0 20px" }}>
            {selectedDoctor.qualifications.map((q, i) => (
              <li key={i} style={{ fontSize: "16px", color: "#5a6778", marginBottom: "5px" }}>
                <span style={{ color: "#007a7e", marginRight: "8px" }}>•</span>{q}
              </li>
            ))}
          </ul>
            ...
            <>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 20px" }}>
                {selectedDoctor.awards.map((a, i) => (
                  <li key={i} style={{ fontSize: "16px", color: "#5a6778", marginBottom: "5px" }}>
                    <span style={{ color: "#007a7e", marginRight: "8px" }}>★</span>{a}
                  </li>
                ))}
              </ul>
            </>
          ...
          <p style={{ fontSize: "16px", color: "#5a6778", margin: "0" }}>
            Email: <a href={`mailto:${selectedDoctor.contact}`} style={{ color: "#007a7e", textDecoration: "none" }}>{selectedDoctor.contact}</a>
          </p>
          <p style={{ fontSize: "16px", color: "#5a6778", margin: "5px 0 0" }}>
            Phone: <a href={`tel:${selectedDoctor.phone}`} style={{ color: "#007a7e", textDecoration: "none" }}>{selectedDoctor.phone}</a>
          </p>
        </div>
      </div>
    </div>
