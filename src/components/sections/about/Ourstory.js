        ...
        <div className="row" style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}> {/* Increased gap */}
          ...
          <div
            style={{
              ...
              boxShadow: hoveredSection === 'story' ? '0 25px 60px rgba(0, 77, 79, 0.25)' : '0 12px 35px rgba(0, 77, 79, 0.12)', // Enhanced shadow on hover
          ...
          >
            ...
            >
              Understanding these challenges, <strong style={{ color: '#007a7e' }}>Vaidya Bandhu was created to bridge the gap between patients and affordable healthcare.</strong>
          ...
          >
            ...
            <p
              style={{
                ...
                boxShadow: '0 10px 25px rgba(0, 122, 126, 0.15)', /* More prominent shadow */
                opacity: animated ? 1 : 0,
                transform: animated ? "translateY(0)" : "translateY(20px)",
...
inclusivity. 
          ...
          <div
            style={{
              ...
              borderRadius: '20px',
              border: '1px solid rgba(0, 77, 79, 0.1)',
              boxShadow: hoveredSection === 'mission' ? '0 25px 60px rgba(0, 77, 79, 0.25)' : '0 12px 35px rgba(0, 77, 79, 0.12)',
              transition: baseTransition,
              opacity: animated ? 1 : 0,
              transform: animated ? "translateY(0) scale(1)" : "translateY(50px) scale(0.98)",
                  ...
                  {[
                    ...
                    <li
                      ...
                      style={{
                        ...
                        border: '1px solid rgba(0, 122, 126, 0.1)', /* Consistent border */
                        boxShadow: '0 4px 12px rgba(0, 77, 79, 0.06)', /* Subtle shadow */
                        opacity: animated ? 1 : 0,
                        transform: animated ? "translateY(0)" : "translateY(15px)",
                        transition: `opacity 0.8s ease-out ${1.0 + index * 0.1}s, transform 0.8s ease-out ${1.0 + index * 0.1}s`, // Staggered list item animation
                      }}
                    >
                      <span style={{ marginRight: '18px', color: '#007a7e', fontSize: '1.6rem', lineHeight: '1', flexShrink: 0 }}>✔</span> {/* Accent color checkmark */}
                      {item}
                    </li>
                  ))}
                </ul>
