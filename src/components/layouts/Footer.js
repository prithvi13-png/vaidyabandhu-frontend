...
class Footer extends Component {
  render() {
    const isArray = Array.isArray(serviceblock);
          ...
          <div className="sigma_info-wrapper style-26 mb-5">
            <div className="sigma_info style-26">
              ...
              <div className="sigma_info-description">
                <p>Our Address</p>
                <p className="secondary-color"><b>Bangalore - 560078</b></p>
              </div>
            </div>
            ...
            <div className="sigma_info style-26">
              ...
              <div className="sigma_info-description">
                <p>Call Us</p>
                <p className="secondary-color"><b>+91 8535853589</b></p>
              </div>
            </div>
            ...
            <div className="sigma_info style-26">
              ...
              <div className="sigma_info-description">
                <p>Our Mail</p>
                <p className="secondary-color"><b>support@vaidyabandhu.com</b></p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-lg-3 col-sm-3">
                <div className="sigma_footer-widget">
                  ...
                  <ul className="sigma_footer-links">
                    {isArray && serviceblock.slice(0, 5).map((item, i) => (
                      <li key={i}>
              ...
              <div className="col-lg-2 col-sm-3">
                <div className="sigma_footer-widget">
                  ...
                  <ul className="sigma_footer-links">
                    ...
                    <li><Link to="/doctor-grid">Doctors</Link></li>
